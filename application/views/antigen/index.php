...
<body>
	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" id="antigenForm" method="POST">
				...
				<div class="wrap-input100 validate-input">
					<input class="input100" type="text" name="participant_nik" id="participant_nik" placeholder="NIK">
					<span class="focus-input100"></span>
				</div>
				...
				<div class="wrap-input100 validate-input">
					<p>Hasil Antigen</p>
					  <input type="radio" id="negatif" name="antigen" value="1">
					  <label for="negatif">Negatif</label><br>

					  <input type="radio" id="positif" name="antigen" value="2">
	...
	<script src="<?= base_url(); ?>assets/js/pages/antigen.js"></script>
